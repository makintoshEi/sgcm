<?php 
	...
	*/
	class Mdmh extends CI_Model
	{
		...
		{
			$this->db->insert('detalle_medico_horario',$data);
		}

		public function update($data,$where)
		{
			$this->db->update('detalle_medico_horario',$data,$where);
		}
		...
		{
			return $this->db->get('detalle_medico_horario')->result_array();
		}
